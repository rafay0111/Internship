...
from Downstream.Dim_1.PudMed20k.model.Unimodel import Unified_Model
import timeit, time
...
def get_arguments():
    ...
    parser.add_argument("--data_path", type=str, default=r"D:\PudMed20K")
...
def main():
    ...
    with Engine(custom_parser=parser) as engine:
        ...
        shutil.copytree(r"C:\Users\Rafay\OneDrive\Desktop\Work\Moffitt Internship\MedCoss\GitHub Repo\Downstream\Dim_1\PudMed20k", os.path.join(args.snapshot_dir, "code"))
        shutil.copyfile(r"C:\Users\Rafay\OneDrive\Desktop\Work\Moffitt Internship\MedCoss\GitHub Repo\run_ds.sh", os.path.join(args.snapshot_dir, "code", "run_ds.sh"))
        print("code copy!")
